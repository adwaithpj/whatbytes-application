...
SECRET_KEY = config('SECRET_KEY', default='django-insecure-f**#pye)l#t8tc#0p0j)r===$)($jf!^5v&5r_vnklr@hyjo4s')
...
# Priority order: DATABASE_URL -> individual env vars -> SQLite fallback
if config('DATABASE_URL', default=None):
    # Use DATABASE_URL if provided (supports full PostgreSQL URLs)
    DATABASES = {
